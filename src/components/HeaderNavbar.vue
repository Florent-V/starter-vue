  ...
  <header>
    <nav class="bg-white dark:bg-gray-800 shadow-md p-4 flex justify-between items-center">
      ...
      <div class="flex items-center">
        <p v-if="user">Bienvenue, {{ user.firstName }}!</p>
      ...
      <button @click="toggleTheme"
              class="relative inline-flex items-center justify-center w-12 h-6 bg-gray-300 dark:bg-gray-600 rounded-full p-1 transition duration-300 focus:outline-none">
